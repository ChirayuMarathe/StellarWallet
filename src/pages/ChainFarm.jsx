          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-white mb-2">About ChainFund</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                    ChainFund is a decentralized platform connecting blockchain innovation with real-world impact. We fund sustainable development projects, support emerging technologies, and build communities that drive positive change through transparent, blockchain-powered giving.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="card text-center">
              ...
              <p className="text-gray-400 mb-6">
                Connect your Stellar wallet to start staking CHAIN tokens and earning rewards while supporting the ChainFund ecosystem
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
