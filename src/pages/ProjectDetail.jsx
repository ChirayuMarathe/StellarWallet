        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              {/* Project Image */}
              <div className="w-full h-96 bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl mb-12 flex items-center justify-center overflow-hidden">
